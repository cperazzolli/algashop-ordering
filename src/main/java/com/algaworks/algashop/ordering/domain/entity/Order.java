...
import com.algaworks.algashop.ordering.domain.exception.OrderDoesNotContainOrderException;
...
public class Order {
    ...
    public Order(OrderId id, CustomerId customerId, Money totalAmount, Quantity quantity, OffsetDateTime placedAt, OffsetDateTime paidAt,
                 OffsetDateTime canceledAt, OffsetDateTime readyAt, BillingInfo billingInfo, ShippingInfo shippingInfo, OrderStatus status,
    ...
    public void addItem(ProductId productId, ProductName name, Money price, Quantity quantity) {
    ...
    public void place() {
        ...
        this.placedStatus(OrderStatus.PLACED);
    }

    public void markAsPaid() {
        this.setPaidAt(OffsetDateTime.now());
        this.placedStatus(OrderStatus.PAID);
    }
    ...
    private void placedStatus(OrderStatus newStatus) {
