...
public class OrderCannotBePlacedException extends DomainException{
    ...
    public static OrderCannotBePlacedException invalidShippingCost(OrderId id) {
        return new OrderCannotBePlacedException(String.format(ERROR_ORDER_CANNOT_BE_PLACED_HAS_NO_VALID_SHIPPING_COST, id));
    }

    public static OrderCannotBePlacedException invalidExpectedDeliveryDate(OrderId id) {
        return new OrderCannotBePlacedException(String.format(ERROR_ORDER_CANNOT_BE_PLACED_HAS_NO_VALID_DELIVERY_DATE, id));
    }
